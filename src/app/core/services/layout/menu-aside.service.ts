...
export class MenuAsideService {
	...
	leftAsideMenuMinimized: BehaviorSubject<boolean> = new BehaviorSubject(false);
	...
	getLeftAsideMenuMinimized() : Observable<boolean> {
		return this.leftAsideMenuMinimized;
	}

	setLeftAsideMenuMinimized(value) {
		this.leftAsideMenuMinimized.next(value);
	}
}
